...
function LegalNotice() {
  return <>
    <section><h2>1. Titular del sitio web</h2><p>Este sitio web es titularidad de <strong>TIKI TAKA GAMES, S.L.</strong>, con NIF <strong>B30165104</strong> y domicilio en Avenida de Pinatar, 40, 30730 San Javier (Murcia).</p><ul><li>Registro Mercantil de Murcia: tomo 3275, folio 189, sección 8, hoja MU-5631.</li><li>Teléfono: <a href="tel:+34968573201">+34 968 57 32 01</a></li><li>Correo electrónico: <a href="mailto:info@tikitaka.es">info@tikitaka.es</a></li></ul></section>
...
function PrivacyPolicy() {
  return <>
    <section><h2>1. Responsable del tratamiento</h2><p><strong>TIKI TAKA GAMES, S.L.</strong> · NIF B30165104 · Avenida de Pinatar, 40, 30730 San Javier (Murcia) · <a href="mailto:info@tikitaka.es">info@tikitaka.es</a> · <a href="tel:+34968573201">+34 968 57 32 01</a>.</p><p>Contacto de privacidad: <a href="mailto:dpo@tikitaka.es">dpo@tikitaka.es</a>. Delegado de Protección de Datos: FENIX CONSULTING SOLUTIONS, S.L.U., <a href="mailto:dpo@fenixconsultores.es">dpo@fenixconsultores.es</a>.</p></section>
    <section><h2>2. Datos, finalidades y bases jurídicas</h2><div className="legal-table-wrap"><table><thead><tr><th>Tratamiento</th><th>Datos</th><th>Finalidad y base jurídica</th></tr></thead><tbody><tr><td>Consultas</td><td>Identificación, contacto y contenido del mensaje</td><td>Atender solicitudes y realizar gestiones precontractuales; consentimiento o medidas solicitadas por la persona interesada.</td></tr><tr><td>Analítica web</td><td>Identificador en línea, dispositivo, navegación y ubicación aproximada</td><td>Medir el uso y mejorar la web; consentimiento, que puede retirarse en cualquier momento.</td></tr><tr><td>Obligaciones y seguridad</td><td>Datos necesarios para acreditar actuaciones e incidencias</td><td>Cumplimiento legal e interés legítimo en proteger el sitio y ejercer o defender reclamaciones.</td></tr></tbody></table></div><p>Las candidaturas de empleo se gestionan desde la plataforma enlazada en la sección «Empleo», que muestra su propia información de privacidad antes de recoger datos.</p></section>
...
const pageInfo = {
  "aviso-legal": { eyebrow: "Información corporativa", title: "Aviso legal", intro: "Identificación del titular y condiciones de uso de la web.", content: <LegalNotice /> },
  privacidad: { eyebrow: "Protección de datos", title: "Política de privacidad", intro: "Información clara sobre cómo tratamos y protegemos los datos personales.", content: <PrivacyPolicy /> },
  cookies: { eyebrow: "Preferencias de navegación", title: "Política de cookies", intro: "Tecnologías utilizadas, finalidad y control de tus preferencias.", content: <CookiePolicy /> },
};
...
export function LegalPage({ kind, assetBase = "/" }: { kind: LegalPageKind; assetBase?: string }) {
  ...
  return <>
    ...
    <main id="contenido-legal" className="legal-page">
      <div className="legal-hero"><p>{page.eyebrow}</p><h1>{page.title}</h1><span>{page.intro}</span><small>Última actualización: {updated}</small></div>
      <article className="legal-content">{page.content}</article>
    </main>
