...
export function SitePage({ content }: { content: SiteContent }) {
  ...
  return (
    <main>
      ...
      <section className="play-showcase" id="play" style={{ height: `${content.motion.playSceneHeight}vh` }}>
        <div className="play-sticky">
          ...
          <div className="play-cherry" aria-hidden="true">
            <span><img src="/tikitaka-cherry.png" alt="" /></span>
          ...
          <div className="section-shell history-shell">
            ...
            <div className="timeline-window" data-reveal>
              <div className="timeline">
                ...
                <div className="timeline-end" aria-hidden="true"><img src="/tikitaka-cherry.png" alt="" /><span>SEGUIMOS JUGANDO</span></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer id="contacto">
        <div className="footer-signature" aria-hidden="true"><span>TIKI TAKA</span><img src="/tikitaka-cherry.png" alt="" /><span>GAMES</span></div>
