...
export const DEFAULT_SITE_CONTENT: SiteContent = {
  ...
  hero: {
    ...
    slides: [
      { id: "hq-night", type: "image", src: "/hero-hq-night.webp", alt: "Nueva sede Tiki Taka de noche" },
      { id: "elche", type: "image", src: "/hero-elche.webp", alt: "Nuevo salón Tiki Taka en Elche" },
      { id: "hq-day", type: "image", src: "/hero-hq-day.webp", alt: "Nueva sede Tiki Taka de día" },
  ...
  footer: { tagline: "Más de 50 años creando experiencias de ocio.", email: "info@tikitaka.es", phone: "+34 968 57 32 01", address: "Av. Pinatar, 40\n30730 San Javier, Murcia", legalUrl: "https://www.tikitaka.es/aviso-legal/", privacyUrl: "https://www.tikitaka.es/politica-privacidad/", cookiesUrl: "https://www.tikitaka.es/politica-de-privacidad/", ethicsUrl: "https://canal-etico.tikitaka.es/es/" },
  legal: {
    updatedAt: "21 de septiembre de 2026",
    companyName: "TIKI TAKA GAMES, S.L.", taxId: "B30165104",
    registry: "Registro Mercantil de Murcia: tomo 3275, folio 189, sección 8, hoja MU-5631.",
    address: "Avenida de Pinatar, 40, 30730 San Javier (Murcia)", phone: "+34 968 57 32 01", email: "info@tikitaka.es",
    privacyEmail: "dpo@tikitaka.es", dpoName: "SYMLOGIC, S.L. (LEGITEC)", dpoTaxId: "B73199283", dpoEmail: "info@legitec.com",
    contactPurpose: "Mantenimiento de contactos.",
    dataSource: "El correo electrónico ha sido facilitado por la propia persona interesada o por su organización.",
    dataCategories: "Tratamos únicamente la dirección de correo electrónico necesaria para mantener el contacto.",
    rightsText: "Puede acceder, rectificar, suprimir y portar sus datos personales, así como oponerse a su tratamiento y solicitar su limitación.",
  },
  seo: { title: "Tiki Taka Games", description: "Tiki Taka Games: más de 50 años creando experiencias de ocio presencial y online." },
