...
type Section = "overview" | "identity" | "hero" | "intro" | "play" | "areas" | "finder" | "history" | "commitment" | "jobs" | "footer" | "legal" | "seo" | "motion" | "media" | "security" | "revisions";
...
const nav: Array<{ id: Section; label: string; icon: typeof LayoutDashboard }> = [
  ...
  { id: "footer", label: "Contacto y enlaces", icon: Link2 }, { id: "legal", label: "Textos legales", icon: ShieldCheck }, { id: "seo", label: "SEO", icon: Globe2 },
