...
const CONTENT_SECURITY_POLICY = [
  ...
  "img-src 'self' data: blob: https://www.tikitaka.es https://*.tikitaka.es https://*.supabase.co https://*.tile.openstreetmap.org https://*.google-analytics.com",
...
function secureResponse(response: Response, pathname: string) {
  ...
  if (/^\/(?:admin|api\/admin)(?:\/|$)/.test(pathname)) {
    headers.set("x-robots-tag", "noindex, nofollow, noarchive");
  }
  if (/^\/(?:_next\/static|assets)\//.test(pathname)) {
